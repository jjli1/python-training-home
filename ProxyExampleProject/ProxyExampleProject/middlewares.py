...
class ProxyexampleprojectSpiderMiddleware:
...
class ProxyexampleprojectDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
#         print('==================>proxy_list=', proxy_list_file)
...
#                 scheme = proxy["scheme"]
#                 url = proxy["proxy"]
#                 print('---------->scheme = ', proxy["scheme"])
#                 print('---------->url = ', proxy["proxy"])
#                 print('==================>self._get_proxy=',
#                       self._get_proxy(url, scheme))
