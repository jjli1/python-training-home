    ...
    def parse(self, response):
        ...
        for tr in trs:
            ...
            if len(tds) > 6:
                ...
                print(meta)
                yield scrapy.Request('https://httpbin.org/ip', callback=self.proxy_check_available, meta=meta, dont_filter=True, errback=self.errback)
